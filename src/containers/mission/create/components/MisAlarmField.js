    ...
    <View>
      <View style={styles.alarmHeader}>
        <View style={styles.rowContainer}>
          <Image source={require('../../../../assets/images/alarm.png')}></Image>
          <Text style={styles.alarmTitle}> 알람설정 </Text>
          <View style={styles.toggleContainer}>
            <TouchableOpacity style={styles.buttonContainerRight} onPress={checkAlarmOn}>
              {isAlarmSet == true ? (
                <Image source={require('../../../../assets/images/toggleOn.png')}></Image>
              ) : (
                <Image source={require('../../../../assets/images/toggleOff.png')}></Image>
              )}
            </TouchableOpacity>
          </View>
        </View>
